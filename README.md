...
## Environments
- Preview: https://main--brightline-demo--anagarwa.aem.page/
- Live: https://main--brightline-demo--anagarwa.aem.live/
...
1. Open the `brightline-demo` directory in your favorite IDE and start coding :)
